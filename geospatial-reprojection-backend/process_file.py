...
def is_lat_lon_column(column_values):
    """Heuristic to determine if a column is latitude or longitude."""
...
def reproject_coordinates(file_path):
    ...
    try:
        ...
        if geometry_column:
            ...
            print(f"Latitude and Longitude columns detected: '{lat_column}', '{lon_column}'")
        else:
            print("No recognizable geometry or latitude/longitude columns found")
